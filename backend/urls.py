...
from product.views import ProductDetailView, ProductSearchView, ProductViewSet, ReviewViewSet, TeamViewSet, SoccerPlayerViewSet
...
urlpatterns = [
     ...
     path('products/search-results/', ProductSearchView.as_view(), name='product_search'),
